 ...
 * href="https://stripe-php.com/docs/api#invoices">invoices</a> or <a
 * href="https://stripe-php.com/docs/api#create_order-coupon">orders</a>. Coupons do
 * not work with conventional one-off <a
 * href="https://stripe-php.com/docs/api#create_charge">charges</a>.
 *
 ...
 * @property null|string $currency If <code>amount_off</code> has been set, the three-letter <a href="https://stripe-php.com/docs/currencies">ISO code for the currency</a> of the amount to take off.
