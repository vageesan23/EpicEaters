 ...
 * href="https://stripe-php.com/docs/connect/accounts">create and manage Express or
 * Custom accounts</a>.
 *
 ...
 * @property string $default_currency Three-letter ISO currency code representing the default currency for the account. This must be a currency that <a href="https://stripe-php.com/docs/payouts">Stripe supports in the account's country</a>.
 ...
 * @property \Stripe\Person $individual <p>This is an object representing a person associated with a Stripe account.</p><p>Related guide: <a href="https://stripe-php.com/docs/connect/identity-verification-api#person-information">Handling Identity Verification with the API</a>.</p>
