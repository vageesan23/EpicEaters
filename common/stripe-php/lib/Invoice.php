 ...
 *
 * They contain <a href="https://stripe-php.com/docs/api#invoiceitems">invoice
 ...
 * the invoice, <a
 * href="https://stripe-php.com/docs/billing/invoices/workflow/#auto_advance">when
 ...
 * your <a href="https://dashboard.stripe-php.com/account/billing/automatic'">email
 ...
 * href="https://stripe-php.com/docs/api/customers/object#customer_object-account_balance">here</a>.
 *
 * Related guide: <a href="https://stripe-php.com/docs/billing/invoices/sending">Send
 ...
 * @property bool $auto_advance Controls whether Stripe will perform <a href="https://stripe-php.com/docs/billing/invoices/workflow/#auto_advance">automatic collection</a> of the invoice. When <code>false</code>, the invoice's state will not automatically advance without an explicit action.
 ...
 * @property null|\Stripe\StripeObject $metadata Set of <a href="https://stripe-php.com/docs/api/metadata">key-value pairs</a> that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
 ...
 * @property null|string $status The status of the invoice, one of <code>draft</code>, <code>open</code>, <code>paid</code>, <code>uncollectible</code>, or <code>void</code>. <a href="https://stripe-php.com/docs/billing/invoices/workflow#workflow-overview">Learn more</a>
