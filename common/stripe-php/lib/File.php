 ...
 * href="https://stripe-php.com/docs/api#create_file">create file</a> request (for
 ...
 * query</a>).
 *
 * Related guide: <a href="https://stripe-php.com/docs/file-upload">File Upload
 * Guide</a>.
 *
 ...
 * @property null|\Stripe\Collection $links A list of <a href="https://stripe-php.com/docs/api#file_links">file links</a> that point at this file.
 * @property string $purpose The <a href="https://stripe-php.com/docs/file-upload#uploading-a-file">purpose</a> of the uploaded file.
...
class File extends ApiResource
{
    ...
    // versions, only `file` is used, but since stripe-php-php may be used with
