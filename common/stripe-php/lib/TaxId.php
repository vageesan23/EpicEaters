 ...
 * href="https://stripe-php.com/docs/api/customers">customer</a>. A customer's tax IDs
 * are displayed on invoices and credit notes issued for the customer.
 *
 * Related guide: <a href="https://stripe-php.com/docs/billing/taxes/tax-ids">Customer
