 ...
 * @property string[] $supported_payment_methods Payment methods available in the specified country. You may need to enable some payment methods (e.g., <a href="https://stripe-php.com/docs/ach">ACH</a>) on your account before they appear in this list. The <code>stripe-php</code> payment method refers to <a href="https://stripe-php.com/docs/connect/destination-charges">charging through your platform</a>.
