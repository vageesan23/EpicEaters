 ...
 * href="https://stripe-php.com/docs/reporting/statements/api">API Access to Reports
 ...
 *
 * @property string $id The <a href="https://stripe-php.com/docs/reporting/statements/api#available-report-types">ID of the Report Type</a>, such as <code>balance.summary.1</code>.
