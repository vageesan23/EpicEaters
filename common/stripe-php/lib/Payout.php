 ...
 *
 * Related guide: <a href="https://stripe-php.com/docs/payouts">Receiving Payouts</a>.
 *
 ...
 * @property bool $automatic Returns <code>true</code> if the payout was created by an <a href="https://stripe-php.com/docs/payouts#payout-schedule">automated payout schedule</a>, and <code>false</code> if it was <a href="https://stripe-php.com/docs/payouts#manual-payouts">requested manually</a>.
 ...
 * @property null|string $failure_code Error code explaining reason for payout failure if available. See <a href="https://stripe-php.com/docs/api#payout_failures">Types of payout failures</a> for a list of failure codes.
 ...
 * @property string $method The method used to send this payout, which can be <code>standard</code> or <code>instant</code>. <code>instant</code> is only supported for payouts to debit cards. (See <a href="https://stripe-php.com/blog/instant-payouts-for-marketplaces">Instant payouts for marketplaces</a> for more information.)
