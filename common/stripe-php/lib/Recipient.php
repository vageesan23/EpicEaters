 ...
 * href="https://stripe-php.com/docs/connect">Connect</a>, specifically Connect's much
 * more powerful <a href="https://stripe-php.com/docs/api#account">Account objects</a>.
 ...
 * @property null|string|\Stripe\Account $migrated_to The ID of the <a href="https://stripe-php.com/docs/connect/custom-accounts">Custom account</a> this recipient was migrated to. If set, the recipient can no longer be updated, nor can transfers be made to it: use the Custom account instead.
