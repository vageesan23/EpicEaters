 ...
 * href="https://stripe-php.com/docs/payments/checkout">Checkout</a>. We recommend
 ...
 * <a href="https://stripe-php.com/docs/api/customers">Customer</a>, and either the
 * successful <a
 * href="https://stripe-php.com/docs/api/payment_intents">PaymentIntent</a> or an
 * active <a href="https://stripe-php.com/docs/api/subscriptions">Subscription</a>.
 *
 * You can create a Checkout Session on your server and pass its ID to the client
 * to begin Checkout.
 *
 * Related guide: <a href="https://stripe-php.com/docs/payments/checkout/api">Checkout
 * Server Quickstart</a>.
 *
 ...
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe-php.com/docs/currencies">supported currency</a>.
