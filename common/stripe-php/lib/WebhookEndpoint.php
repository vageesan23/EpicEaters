...
/**
 * You can configure <a href="https://stripe-php.com/docs/webhooks/">webhook
 ...
 * href="https://dashboard.stripe-php.com/webhooks">the dashboard</a>, which provides a
 * user interface for registering and testing your webhook endpoints.
 *
 * Related guide: <a href="https://stripe-php.com/docs/webhooks/configure">Setting up
 * Webhooks</a>.
 *
 ...
 * @property string $secret The endpoint's secret, used to generate <a href="https://stripe-php.com/docs/webhooks/signatures">webhook signatures</a>. Only returned at creation.
