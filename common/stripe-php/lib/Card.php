 ...
 *
 * Related guide: <a href="https://stripe-php.com/docs/sources/cards">Card Payments
 * with Sources</a>.
 *
 ...
 * @property null|string $currency Three-letter <a href="https://stripe-php.com/docs/payouts">ISO code for currency</a>. Only applicable on accounts (not customers or recipients). The card can be used as a transfer destination for funds in this currency.
