 ...
 * @property \Stripe\Coupon $coupon A coupon contains information about a percent-off or amount-off discount you might want to apply to a customer. Coupons may be applied to <a href="https://stripe-php.com/docs/api#invoices">invoices</a> or <a href="https://stripe-php.com/docs/api#create_order-coupon">orders</a>. Coupons do not work with conventional one-off <a href="https://stripe-php.com/docs/api#create_charge">charges</a>.
