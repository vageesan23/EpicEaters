 ...
 * href="https://stripe-php.com/docs/payments">recommended payments integrations</a> to
 ...
 * href="https://stripe-php.com/docs/api#customers">Customer</a> objects or <a
 * href="https://stripe-php.com/docs/api#external_accounts">Custom accounts</a>. Note
 * that <a href="https://stripe-php.com/docs/radar">Radar</a>, our integrated solution
 * for automatic fraud protection, supports only integrations that use client-side
 * tokenization.
 *
 * Related guide: <a
 * href="https://stripe-php.com/docs/payments/accept-a-payment-charges#web-create-token">Accept
 * a payment</a>
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property \Stripe\BankAccount $bank_account <p>These bank accounts are payment methods on <code>Customer</code> objects.</p><p>On the other hand <a href="https://stripe-php.com/docs/api#external_accounts">External Accounts</a> are transfer destinations on <code>Account</code> objects for <a href="https://stripe-php.com/docs/connect/custom-accounts">Custom accounts</a>. They can be bank accounts or debit cards as well, and are documented in the links above.</p><p>Related guide: <a href="https://stripe-php.com/docs/payments/bank-debits-transfers">Bank Debits and Transfers</a>.</p>
 * @property \Stripe\Card $card <p>You can store multiple cards on a customer in order to charge the customer later. You can also store multiple debit cards on a recipient in order to transfer to those cards later.</p><p>Related guide: <a href="https://stripe-php.com/docs/sources/cards">Card Payments with Sources</a>.</p>
