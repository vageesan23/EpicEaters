 ...
 * unique, random ID.
 *
 * Related guide: <a href="https://stripe-php.com/docs/connect/top-ups">Topping Up your
 * Platform Account</a>.
 *
 ...
 * @property null|string $failure_code Error code explaining reason for top-up failure if available (see <a href="https://stripe-php.com/docs/api#errors">the errors section</a> for a list of codes).
 ...
 * @property \Stripe\Source $source <p><code>Source</code> objects allow you to accept a variety of payment methods. They represent a customer's payment instrument, and can be used with the Stripe API just like a <code>Card</code> object: once chargeable, they can be charged, or can be attached to customers.</p><p>Related guides: <a href="https://stripe-php.com/docs/sources">Sources API</a> and <a href="https://stripe-php.com/docs/sources/customers">Sources &amp; Customers</a>.</p>
