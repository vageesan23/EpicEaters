 ...
 *
 * On the other hand <a
 * href="https://stripe-php.com/docs/api#external_accounts">External Accounts</a> are
 * transfer destinations on <code>Account</code> objects for <a
 * href="https://stripe-php.com/docs/connect/custom-accounts">Custom accounts</a>. They
 * can be bank accounts or debit cards as well, and are documented in the links
 * above.
 *
 * Related guide: <a
 * href="https://stripe-php.com/docs/payments/bank-debits-transfers">Bank Debits and
 * Transfers</a>.
 *
 ...
 * @property string $currency Three-letter <a href="https://stripe-php.com/docs/payouts">ISO code for the currency</a> paid out to the bank account.
