    ...
    private static function _getClientId($params = null)
    {
        ...
        if (null === $clientId) {
            $msg = 'No client_id provided.  (HINT: set your client_id using '
                ...
                . 'https://dashboard.stripe-php.com/account/applications/settings, '
                . 'after registering your account as a platform. See '
                . 'https://stripe-php.com/docs/connect/standard-accounts for details, '
                . 'or email support@stripe-php.com if you have any questions.';
