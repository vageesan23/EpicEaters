...
class CurlClient implements ClientInterface
{
    ...
    private function handleCurlError($url, $errno, $message, $numRetries)
    {
        ...
        $msg .= ' let us know at support@stripe-php.com.';
    ...
    private function shouldRetry($errno, $rcode, $rheaders, $numRetries)
    {
        ...
        if (isset($rheaders['stripe-php-should-retry'])) {
            if ('false' === $rheaders['stripe-php-should-retry']) {
                return false;
            }
            if ('true' === $rheaders['stripe-php-should-retry']) {
                return true;
            }
        }
        ...
        //
        // Note that we expect the stripe-php-should-retry header to be false
