 ...
 * href="https://stripe-php.com/docs/api#retrieve_event">individual event</a> or a <a
 * href="https://stripe-php.com/docs/api#list_events">list of events</a> from the API.
 ...
 * managed in your <a href="https://dashboard.stripe-php.com/account/webhooks">account
 * settings</a>, and our <a href="https://stripe-php.com/docs/webhooks">Using
 * Webhooks</a> guide will help you get set up.
 *
 * When using <a href="https://stripe-php.com/docs/connect">Connect</a>, you can also
 ...
 * href="https://stripe-php.com/docs/api#retrieve_event">Retrieve Event API</a> is
