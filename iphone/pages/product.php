...
<div data-role="page" id="product">
    ...
    <div role="main" class="ui-content">
        ...
        <div class="header-title" style="display: flex;">
            <span class="iconify page-icon" alt="page_icon" data-icon="uil:parcel" data-width="30"
                data-height="30"></span>
        ...
        <div class="main-part" style="width: 100%;">
            <div class="ui-bar ui-bar-a ui-card main-card">
                ...
                <div class="ui-grid-a">
                    ...
                    ?>
                        <p class="card-price main-pr-price">LKR
                            <?php echo $json[$id]['price'] ?? '' ?>
                        </p>
                        <div class="ui-block-a" style="width:80%">
                            <div style="margin-top: 1px">
                                <p class="main-desc" style="font-weight: 300;">
                                ...
                                <div data-role="collapsible" data-enhanced="true"
                                    ...
                                    <span class="ui-collapsible-heading ui-collapsible-heading-collapsed read-more"
                                    ...
                                    <div class="ui-collapsible-content ui-collapsible-content-collapsed long-desc"
                                        aria-hidden="true">
                                        <p>
                                    ...
                                    <div
                                        style="display: inline-flex;width: 100%; justify-content: center; margin-left: 10px;">
                                        ...
                                        <span>
                                            <a href="#cart-feedback" data-rel="popup" data-position-to="window"
                                                data-transition="pop">
                                                <img src="../../common/assets/images/icons/product-cart.png" alt="cart"
                                                    id="addToCart" class="cart-icon">
                                            </a>
                                        </span>
                                        <span>
                                            <a style="margin: 10px">
